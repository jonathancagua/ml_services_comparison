...
class MLServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                ...
                request_serializer=ml__service__pb2.Feature.SerializeToString,
...
def add_MLServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Predict': grpc.unary_unary_rpc_method_handler(
                    servicer.Predict,
                    request_deserializer=ml__service__pb2.Feature.FromString,
...
class MLService(object):
    ...
    def Predict(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ml_service.MLService/Predict',
            ml__service__pb2.Feature.SerializeToString,
